...
**Tests**: The examples below include test tasks. Tests are MANDATORY per the constitution's TDD NON-NEGOTIABLE principle. All features MUST have tests written before implementation (Red-Green-Refactor cycle).
